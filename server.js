...
app.post('/gallery/addProduct', function(req, res){
	...
	blobService.getBlobToFile(index_container, 'packages.json', __dirname + '/databases/packages.json', function(error, result, response){
		...
		form.parse(req, function(err, fields, files){
			...
			var product = {"type" : "product", "name" : fields.inputName, "link" : name, "description" : fields.inputDescription, "price" : 0, "file" : name + extImg, "package" : name + ".zip", "category" : fields.inputCategory, "application" : applications,"captures": captures, "countView" : 0, "countOrder" : 0, "captures": captures};
